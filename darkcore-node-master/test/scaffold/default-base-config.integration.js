...
describe('#defaultBaseConfig', function() {
  it('will return expected configuration', function() {
    ...
    darksagad.spawn.datadir.should.equal(home + '/.dark');
    darksagad.spawn.exec.should.equal(path.resolve(__dirname, process.env.HOME, './.dark/darksagad'));
  });
  ...
  it('be able to specify a datadir', function() {
    ...
    info.config.servicesConfig.darksagad.spawn.datadir.should.equal('./data2');
  });
});
