...
module.exports.services.dark = require('./lib/services/darksagad');
...
module.exports.cli.darkcore = require('./lib/cli/darkcore');
module.exports.cli.darkcored = require('./lib/cli/darkcored');

module.exports.lib = require('@darkevo/darkcore-lib');
