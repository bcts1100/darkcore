...
var darkcorenode = require('..');
var utils = require('../utils');

function main(servicesPath, additionalServices) {
  /* jshint maxstatements: 100 */

  var version = darkcorenode.version;
  var create = darkcorenode.scaffold.create;
  var add = darkcorenode.scaffold.add;
  var start = darkcorenode.scaffold.start;
  var remove = darkcorenode.scaffold.remove;
  var callMethod = darkcorenode.scaffold.callMethod;
  var findConfig = darkcorenode.scaffold.findConfig;
  var defaultConfig = darkcorenode.scaffold.defaultConfig;
  ...
  program
    ...
    .option('-c, --config <dir>', 'Specify the directory with darkcore Node configuration')
    .option('-d, --daemon', 'Make darkcore-node a daemon (running in the background)')
    .action(function(cmd){
      if (cmd.config) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `darkcore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ darkcore-node add wallet-service');
      console.log('    $ darkcore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ darkcore-node remove wallet-service');
      console.log('    $ darkcore-node remove insight-api');
      console.log();
    });
