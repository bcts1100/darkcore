...
/**
 * Will return the path and darkcore-node configuration
...
function findConfig(cwd) {
  ...
  while (!fs.existsSync(path.resolve(directory, 'darkcore-node.json'))) {
  ...
  return {
    path: directory,
    config: require(path.resolve(directory, 'darkcore-node.json'))
  };
}
